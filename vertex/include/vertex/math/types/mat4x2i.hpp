...
template <typename T>
struct mat_t<4, 2, T, __detail::component_type::_i>
{
    ///////////////////////////////////////////////////////////////////////////////
    // meta
    ///////////////////////////////////////////////////////////////////////////////
    ...
    template <
        ...
        VXM_REQ_NUM8(X1, Y1, X2, Y2, X3, Y3, X4, Y4)>
    VX_FORCE_INLINE constexpr mat_t(
        X1 x1, Y1 y1,
        X2 x2, Y2 y2,
        X3 x3, Y3 y3,
    ...
    template <typename C1, typename C2, typename C3, typename C4, VXM_REQ_NUM4(C1, C2, C3, C4)>
    VX_FORCE_INLINE constexpr mat_t(
        const vec<2, C1>& c1,
        const vec<2, C2>& c2,
        const vec<2, C3>& c3,
