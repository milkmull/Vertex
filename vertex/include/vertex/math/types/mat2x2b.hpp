...
template <typename T>
struct mat_t<2, 2, T, __detail::component_type::_b>
{
    ///////////////////////////////////////////////////////////////////////////////
    // meta
    ///////////////////////////////////////////////////////////////////////////////
    ...
    VX_FORCE_INLINE constexpr mat_t(const col_type& c1, const col_type& c2) noexcept
        : columns{ c1, c2 } {}
    ...
    template <typename C1, typename C2, VXM_REQ_NUM2(C1, C2)>
    VX_FORCE_INLINE constexpr mat_t(const vec<height, C1>& c1, const vec<height, C2>& c2) noexcept
