...
///
/// This function takes three Euler angles (t1, t2, t3) in radians representing
/// rotations around the X, Y, and Z axes, respectively. It computes and returns
...
///
/// This function takes three Euler angles (t1, t2, t3) in radians representing
/// rotations around the X, Z, and Y axes, respectively. It computes and returns
/// the corresponding quaternion.
///
/// @param t1 The rotation angle around the X-axis in radians.
...
///
/// This function takes three Euler angles (t1, t2, t3) in radians representing
/// rotations around the Y, X, and Z axes, respectively. It computes and returns
/// the corresponding quaternion.
///
...
///
/// This function takes three Euler angles (t1, t2, t3) in radians representing
/// rotations around the Y, Z, and X axes, respectively. It computes and returns
/// the corresponding quaternion.
///
/// @param t1 The rotation angle around the Y-axis in radians.
/// @param t2 The rotation angle around the Z-axis in radians.
...
///
/// This function takes three Euler angles (t1, t2, t3) in radians representing
/// rotations around the Z, X, and Y axes, respectively. It computes and returns
/// the corresponding quaternion.
///
...
///
/// This function takes three Euler angles (t1, t2, t3) in radians representing
/// rotations around the Z, Y, and X axes, respectively. It computes and returns
/// the corresponding quaternion.
///
/// @param t1 The rotation angle around the Z-axis in radians.
/// @param t2 The rotation angle around the Y-axis in radians.
...
///
/// This function takes a quaternion 'q' and computes the corresponding Euler angles
/// (t1, t2, t3) in radians representing rotations around the X, Y, and Z axes,
/// respectively.
///
...
///
/// This function takes a quaternion 'q' and computes the corresponding Euler angles
/// (t1, t2, t3) in radians representing rotations around the X, Z, and Y axes,
/// respectively.
///
/// @param q The quaternion to convert.
/// 
...
///
/// This function takes a quaternion 'q' and computes the corresponding Euler angles
/// (t1, t2, t3) in radians representing rotations around the Y, X, and Z axes,
/// respectively.
///
/// @param q The quaternion to convert.
/// 
...
///
/// This function takes a quaternion 'q' and computes the corresponding Euler angles
/// (t1, t2, t3) in radians representing rotations around the Y, Z, and X axes,
/// respectively.
///
/// @param q The quaternion to convert.
/// 
...
///
/// This function takes a quaternion 'q' and computes the corresponding Euler angles
/// (t1, t2, t3) in radians representing rotations around the Z, X, and Y axes,
/// respectively.
///
/// @param q The quaternion to convert.
/// 
...
///
/// This function takes a quaternion 'q' and computes the corresponding Euler angles
/// (t1, t2, t3) in radians representing rotations around the Z, Y, and X axes,
/// respectively.
///
/// @param q The quaternion to convert.
/// 
...
///
/// This function constructs a 3x3 rotation matrix representing rotations around
/// the X, Y, and Z axes, using the provided Euler angles (t1, t2, t3) in radians.
///
...
///
/// This function constructs a 3x3 rotation matrix representing rotations around
/// the X, Z, and Y axes, using the provided Euler angles (t1, t2, t3) in radians.
///
/// @param t1 The rotation angle around the X-axis.
...
///
/// This function constructs a 3x3 rotation matrix representing rotations around
/// the Y, X, and Z axes, using the provided Euler angles (t1, t2, t3) in radians.
///
...
///
/// This function constructs a 3x3 rotation matrix representing rotations around
/// the Y, Z, and X axes, using the provided Euler angles (t1, t2, t3) in radians.
///
/// @param t1 The rotation angle around the Y-axis.
/// @param t2 The rotation angle around the Z-axis.
...
///
/// This function constructs a 3x3 rotation matrix representing rotations around
/// the Z, X, and Y axes, using the provided Euler angles (t1, t2, t3) in radians.
///
...
///
/// This function constructs a 3x3 rotation matrix representing rotations around
/// the Z, Y, and X axes, using the provided Euler angles (t1, t2, t3) in radians.
///
/// @param t1 The rotation angle around the Z-axis.
/// @param t2 The rotation angle around the Y-axis.
/// @param t3 The rotation angle around the X-axis.
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 3x3 rotation matrix 'm' in XYZ order. The resulting angles represent
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 3x3 rotation matrix 'm' in XZY order. The resulting angles represent
/// rotations around the X, Z, and Y axes.
///
/// @param m The 3x3 rotation matrix.
/// 
/// @return The Euler angles (t1, t2, t3) in radians.
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 3x3 rotation matrix 'm' in YXZ order. The resulting angles represent
/// rotations around the Y, X, and Z axes.
///
/// @param m The 3x3 rotation matrix.
/// 
/// @return The Euler angles (t1, t2, t3) in radians.
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 3x3 rotation matrix 'm' in YZX order. The resulting angles represent
/// rotations around the Y, Z, and X axes.
///
/// @param m The 3x3 rotation matrix.
/// 
/// @return The Euler angles (t1, t2, t3) in radians.
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 3x3 rotation matrix 'm' in ZXY order. The resulting angles represent
/// rotations around the Z, X, and Y axes.
///
/// @param m The 3x3 rotation matrix.
/// 
/// @return The Euler angles (t1, t2, t3) in radians.
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 3x3 rotation matrix 'm' in ZYX order. The resulting angles represent
...
///
/// This function constructs a 4x4 rotation matrix representing rotations around
/// the X, Y, and Z axes, using the provided Euler angles (t1, t2, t3) in radians.
///
/// @param t1 The rotation angle around the X-axis.
/// @param t2 The rotation angle around the Y-axis.
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 4x4 rotation matrix 'm' in XYZ order. The resulting angles represent
/// rotations around the X, Y, and Z axes.
///
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 4x4 rotation matrix 'm' in XZY order. The resulting angles represent
/// rotations around the X, Z, and Y axes.
///
/// @param m The 4x4 rotation matrix.
/// 
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 4x4 rotation matrix 'm' in YXZ order. The resulting angles represent
/// rotations around the Y, X, and Z axes.
///
/// @param m The 4x4 rotation matrix.
/// 
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 4x4 rotation matrix 'm' in YZX order. The resulting angles represent
/// rotations around the Y, Z, and X axes.
///
/// @param m The 4x4 rotation matrix.
/// 
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 4x4 rotation matrix 'm' in ZXY order. The resulting angles represent
/// rotations around the Z, X, and Y axes.
///
/// @param m The 4x4 rotation matrix.
/// 
...
///
/// This function calculates the Euler angles (t1, t2, t3) in radians from the
/// given 4x4 rotation matrix 'm' in ZYX order. The resulting angles represent
/// rotations around the Z, Y, and X axes.
///
/// @param m The 4x4 rotation matrix.
/// 
