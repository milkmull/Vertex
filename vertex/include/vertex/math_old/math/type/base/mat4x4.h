...
struct mat<4, 4, T>
{
    ...
    static VX_FORCE_INLINE constexpr size_t size() noexcept { return static_cast<size_t>(16); }
    static VX_FORCE_INLINE constexpr size_t width() noexcept { return static_cast<size_t>(4); }
    static VX_FORCE_INLINE constexpr size_t height() noexcept { return static_cast<size_t>(4); }
    ...
    VX_FORCE_INLINE constexpr explicit mat(T scalar) noexcept
        : columns{ col_type(scalar, static_cast<T>(0), static_cast<T>(0), static_cast<T>(0)),
                   col_type(static_cast<T>(0), scalar, static_cast<T>(0), static_cast<T>(0)),
                   col_type(static_cast<T>(0), static_cast<T>(0), scalar, static_cast<T>(0)),
                   col_type(static_cast<T>(0), static_cast<T>(0), static_cast<T>(0), scalar) } {}
    ...
    VX_FORCE_INLINE constexpr explicit mat(U scalar)
        : columns{ col_type(static_cast<T>(scalar), static_cast<T>(0), static_cast<T>(0), static_cast<T>(0)),
                   col_type(static_cast<T>(0), static_cast<T>(scalar), static_cast<T>(0), static_cast<T>(0)),
                   col_type(static_cast<T>(0), static_cast<T>(0), static_cast<T>(scalar), static_cast<T>(0)),
                   col_type(static_cast<T>(0), static_cast<T>(0), static_cast<T>(0), static_cast<T>(scalar)) } {}
    ...
    template <typename U>
    VX_FORCE_INLINE constexpr type& operator=(const mat<4, 4, U>& m)
    {
    ...
    template <typename U = T, typename std::enable_if<std::is_same<T, U>::value && type_traits::is_numeric<U>::value, bool>::type = true>
    friend VX_FORCE_INLINE constexpr vec<4, T> operator*(const type& m, const vec<4, T>& v)
    {
        return vec<4, T>(
    ...
    template <typename U = T, typename std::enable_if<std::is_same<T, U>::value && type_traits::is_numeric<U>::value, bool>::type = true>
    friend VX_FORCE_INLINE constexpr vec<4, T> operator*(const vec<4, T>& v, const type& m)
    {
        return vec<4, T>(
    ...
    template <typename U = T, typename std::enable_if<std::is_same<T, U>::value && type_traits::is_numeric<U>::value, bool>::type = true>
    friend VX_FORCE_INLINE constexpr mat<2, 4, T> operator*(const type& m1, const mat<2, 4, T>& m2)
    {
        return mat<2, 4, T>(
    ...
    template <typename U = T, typename std::enable_if<std::is_same<T, U>::value && type_traits::is_numeric<U>::value, bool>::type = true>
    friend VX_FORCE_INLINE constexpr mat<3, 4, T> operator*(const type& m1, const mat<3, 4, T>& m2)
    {
        return mat<3, 4, T>(
            (m1.columns[0].x * m2.columns[0].x) + (m1.columns[1].x * m2.columns[0].y) + (m1.columns[2].x * m2.columns[0].z) + (m1.columns[3].x * m2.columns[0].w),
            (m1.columns[0].y * m2.columns[0].x) + (m1.columns[1].y * m2.columns[0].y) + (m1.columns[2].y * m2.columns[0].z) + (m1.columns[3].y * m2.columns[0].w),
