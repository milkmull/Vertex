...
/// numbers.
///
/// The rng class provides a set of functions for generating random numbers of
/// different types and distributions. It supports seeding, generating integers,
/// floats, booleans, and performing various container operations like shuffling.
///
/// @note The default constructor automatically seeds the RNG using the current
/// system clock.
/// @note The RNG class uses the Mersenne Twister engine (std::mt19937) for
...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////
    /// @brief Seeds the RNG using the current system clock and returns the
    /// generated seed.
    /// 
    ...
    ////////////////////////////////////////////////////////////////////////////////
    /// @brief Generates a random number from a normal distribution with specified
    /// mean and deviation.
    /// 
    ...
    ////////////////////////////////////////////////////////////////////////////////
    /// @brief Selects multiple random elements from one range and assigns them to
    /// another range using the RNG.
    /// 
    ...
    ////////////////////////////////////////////////////////////////////////////////
    /// @brief Chooses multiple elements from one range and assigns them to another
    /// range based on weights.
    /// 
    /// @param first1 Iterator to the beginning of the source range.
    /// @param last1 Iterator to the end of the source range.
    /// @param first2 Iterator to the beginning of the destination range.
