...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/linux.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && (defined(linux) || defined(__linux) || defined(__linux__) || defined(__gnu_linux__))
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/ios.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && (defined(__APPLE__) && defined(__MACH__) && defined(__ENVIRONMENT_IPHONE_OS_VERSION_MIN_REQUIRED__))
...
// macos should be detected after ios
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && (defined(macintosh) || defined(Macintosh) || (defined(__APPLE__) && defined(__MACH__)))
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/bsd/bsdi.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && defined(__bsdi__)
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/bsd/dragonfly.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && defined(__DragonFly__)
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/bsd/free.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && defined(__FreeBSD__)
        ...
        #include <sys/param.h>
                ...
                #define VX_OS_BSD_FREE VX_PRIV_MAKE_VERSION_NUMBER_10_VRPPPP(__FreeBSD_version)
            #else
                #define VX_OS_BSD_FREE VX_PRIV_MAKE_VERSION_NUMBER_10_VVRRPPP(__FreeBSD_version)
            #endif
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/bsd/net.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && (defined(__NETBSD__) || defined(__NetBSD__))
        ...
        #define VX_OS_BSD VX_VERSION_NUMBER_AVAILABLE
                    ...
                    #define VX_OS_BSD_NET VX_PRIV_MAKE_VERSION_NUMBER_10_VRP000(__NETBSD_version)
                #else
                    #define VX_OS_BSD_NET VX_PRIV_MAKE_VERSION_NUMBER_10_VRR000(__NETBSD_version)
                #endif
            #else
                ...
                #define VX_OS_BSD_NET VX_PRIV_MAKE_VERSION_NUMBER_10_VVRR00PP00(__NetBSD_Version)
            #else
                #define VX_OS_BSD_NET VX_VERSION_NUMBER_AVAILABLE
            #endif
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/bsd/open.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && defined(__OpenBSD__)
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/bsd.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && (defined(BSD) || defined(_SYSTYPE_BSD))
        ...
        #elif defined(BSD)
            #define VX_OS_BSD VX_PRIV_MAKE_VERSION_NUMBER_10_VVRR(BSD)
        #else
            #define VX_OS_BSD VX_VERSION_NUMBER_AVAILABLE
        #endif
...
// https://github.com/boostorg/predef/blob/a2a5010e2824b7740890a3bf463b8c4b8927aaa7/include/boost/predef/os/windows.h
    ...
    #if !defined(VX_PRIV_OS_DETECTED) && (defined(_WIN32) || defined(_WIN64) || defined(__WIN32__) || defined(__TOS_WIN__) || defined(__WINDOWS__))
...
#if !defined(VX_PRIV_OS_DETECTED)
