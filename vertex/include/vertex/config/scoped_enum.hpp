...
\
    friend constexpr bool operator==(name lhs, name rhs) noexcept \
    { return static_cast<enum_type>(lhs.m_value) == static_cast<enum_type>(rhs.m_value); } \
    friend constexpr bool operator==(name lhs, enum_type rhs) noexcept \
    { return static_cast<enum_type>(lhs.m_value) == rhs; } \
    friend constexpr bool operator==(enum_type lhs, name rhs) noexcept \
    { return lhs == static_cast<enum_type>(rhs.m_value); } \
\
    friend constexpr bool operator!=(name lhs, name rhs) noexcept \
    { return static_cast<enum_type>(lhs.m_value) != static_cast<enum_type>(rhs.m_value); } \
    friend constexpr bool operator!=(name lhs, enum_type rhs) noexcept \
