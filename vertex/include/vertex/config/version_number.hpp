...
#define VX_PRIV_MAKE_VERSION_NUMBER_10_VRR000(V) VX_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 1000) % 100, 0)

#define VX_PRIV_MAKE_VERSION_NUMBER_10_VV00(V) VX_VERSION_NUMBER(((V) / 100) % 100, 0, 0)

#define VX_PRIV_MAKE_VERSION_NUMBER_10_VVRR(V) VX_VERSION_NUMBER(((V) / 100) % 100, (V) % 100, 0)

#define VX_PRIV_MAKE_VERSION_NUMBER_10_VRP000(V) VX_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 10000) % 10, ((V) / 1000) % 10)

#define VX_PRIV_MAKE_VERSION_NUMBER_10_VRPPPP(V) VX_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 10000) % 10, (V) % 10000)

#define VX_PRIV_MAKE_VERSION_NUMBER_10_VVRRPPP(V) VX_VERSION_NUMBER(((V) / 100000) % 100, ((V) / 1000) % 100, (V) % 1000)
