...
/**
 * @brief Produces random integers in a uniform distribution.
 *
 * This class generates random integer values uniformly distributed in a specified
 * range [a, b], inclusive.
 *
 * @tparam T The integral type used for the distribution.
 */
...
public:
    ...
    /**
     * @brief Parameter structure for the distribution.
     *
     * This structure holds the parameters that define the distribution,
     * specifically the minimum and maximum values.
     */
    struct param_type
    {
        ...
        /**
         * @brief Default constructor initializes the distribution to [0, 0].
         */
        param_type() noexcept : param_type(0) {}

        /**
         * @brief Constructs the parameter structure with the specified minimum and maximum values.
         *
        ...
        /**
         * @brief Gets the minimum value of the distribution.
         *
        ...
        /**
         * @brief Gets the maximum value of the distribution.
         *
         * @return The maximum value, b.
         */
...
public:
    ...
    /**
     * @brief Constructs the distribution with the specified range [a, b].
     *
     * @param min_value The minimum value of the range.
     * @param max_value The maximum value of the range (inclusive).
     */
    ...
    /**
     * @brief Constructs the distribution from the given parameter structure.
     *
     * @param p The parameter structure defining the range.
     */
    ...
    /**
     * @brief Gets the parameters defining the distribution.
     *
     * @return The parameter structure containing the minimum and maximum values.
     */
     ...
     *
     * @param p The new parameter structure to define the range.
     */
    void param(const param_type& p) noexcept { m_param = p; }

    /**
     * @brief Gets the minimum possible value generated by the distribution.
     *
     * @return The minimum value, which is equal to a().
     */
    result_type min() const noexcept { return a(); }

    /**
     * @brief Gets the maximum possible value generated by the distribution.
     *
     * @return The maximum value, which is equal to b().
     */
    result_type max() const noexcept { return b(); }

    /**
     * @brief Calculates the range of the distribution.
     *
     * This function returns the number of possible integer values that
     * can be generated by the distribution, which is equivalent to
     * the difference between the maximum and minimum values, inclusive.
     *
     * @return The number of possible values in the range [a, b].
     */
