...
enum : size_t
{
    invalid_trail_count = std::numeric_limits<size_t>::max()
};
...
struct utf_base_traits<1> // utf8
{
     ...
     */
    static constexpr size_t max_width() noexcept
    {
        return 4;
    }
...
struct utf_base_traits<2> // utf16
{
     ...
     */
    static constexpr bool is_first_surrogate(utype w1) noexcept
    {
        return 0xD800 <= w1 && w1 <= 0xDBFF;
    }
     ...
     */
    static constexpr bool is_second_surrogate(utype w2) noexcept
    {
        return 0xDC00 <= w2 && w2 <= 0xDFFF;
    }
...
struct utf_base_traits<4> // utf32
{
     ...
     */
    static constexpr bool is_trail(utype) noexcept
    {
        return false;
    }
     ...
     */
    static constexpr bool is_lead(utype) noexcept
    {
        return true;
    }
     ...
     * @return Always 1, since UTF-32 encodes each codepoint in a single 32-bit unit.
     */
    static constexpr size_t width(code_point) noexcept
    {
        return 1;
    }
};
