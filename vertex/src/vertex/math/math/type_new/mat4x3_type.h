...
struct mat<4, 3, T>
{
    ...
    template <typename U>
    inline constexpr explicit mat(const mat<4, 3, U>& m)
...
template <typename T>
inline constexpr bool operator==(const mat<4, 3, T>& m1, const mat<4, 3, T>& m2)
{
...
inline constexpr mat<4, 3, T> operator+(const mat<4, 3, T>& m)
{
    return mat<4, 3, T>(+m.columns[0], +m.columns[1], +m.columns[2], +m.columns[3]);
}
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T>& operator++(mat<4, 3, T>& m)
{
    m.columns[0]++;
    m.columns[1]++;
    m.columns[2]++;
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T> operator++(mat<4, 3, T>& m, int)
{
    mat<4, 3, T> result(m);
    ++m;
    return result;
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T> operator+(const mat<4, 3, T>& m, T scaler)
{
    return mat<4, 3, T>(m.columns[0] + scaler, m.columns[1] + scaler, m.columns[2] + scaler, m.columns[3] + scaler);
}

template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T> operator+(T scaler, const mat<4, 3, T>& m)
{
    return mat<4, 3, T>(scaler + m.columns[0], scaler + m.columns[1], scaler + m.columns[2], scaler + m.columns[3]);
}

template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T> operator+(const mat<4, 3, T>& m1, const mat<4, 3, T>& m2)
{
    return mat<4, 3, T>(m1.columns[0] + m2.columns[0], m1.columns[1] + m2.columns[1], m1.columns[2] + m2.columns[2], m1.columns[3] + m2.columns[3]);
}
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr vec<3, T> operator*(const mat<4, 3, T>& m, const vec<4, T>& v)
{
    return vec<3, T>(
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr vec<3, T> operator*(const vec<4, T>& v, const mat<4, 3, T>& m)
{
    return vec<3, T>(
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<2, 3, T> operator*(const mat<4, 3, T>& m1, const mat<2, 4, T>& m2)
{
    return mat<2, 3, T>(
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T> operator*(const mat<4, 3, T>& m1, const mat<3, 4, T>& m2)
{
    return mat<3, 3, T>(
        (m1.columns[0].x * m2.columns[0].x) + (m1.columns[1].x * m2.columns[0].y) + (m1.columns[2].x * m2.columns[0].z) + (m1.columns[3].x * m2.columns[0].w),
        (m1.columns[0].y * m2.columns[0].x) + (m1.columns[1].y * m2.columns[0].y) + (m1.columns[2].y * m2.columns[0].z) + (m1.columns[3].y * m2.columns[0].w),
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T> operator*(const mat<4, 3, T>& m1, const mat<4, 4, T>& m2)
{
    return mat<4, 3, T>(
        (m1.columns[0].x * m2.columns[0].x) + (m1.columns[1].x * m2.columns[0].y) + (m1.columns[2].x * m2.columns[0].z) + (m1.columns[3].x * m2.columns[0].w),
        (m1.columns[0].y * m2.columns[0].x) + (m1.columns[1].y * m2.columns[0].y) + (m1.columns[2].y * m2.columns[0].z) + (m1.columns[3].y * m2.columns[0].w),
...
inline constexpr mat<4, 3, T> operator%(const mat<4, 3, T>& m1, const mat<4, 3, T>& m2)
{
    return mat<4, 3, T>(m1.columns[0] % m2.columns[0], m1.columns[1] % m2.columns[1], m1.columns[2] % m1.columns[2], m1.columns[3] % m2.columns[3]);
}
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T>& operator+=(mat<4, 3, T>& m, T scaler)
{
    m.columns[0] += scaler;
    m.columns[1] += scaler;
    m.columns[2] += scaler;
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T>& operator+=(mat<4, 3, T>& m1, const mat<4, 3, T>& m2)
{
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T>& operator*=(mat<4, 3, T>& m1, const mat<4, 4, T>& m2)
{
    m1 = m1 * m2;
    return m1;
}
