...
struct mat<3, 3, T>
{
    ...
    static inline constexpr size_t size() noexcept { return 9; }
    ...
    inline constexpr mat(const vec<3, C1>& c1, const vec<3, C2>& c2, const vec<3, C3>& c3)
...
template <typename T>
inline constexpr bool operator==(const mat<3, 3, T>& m1, const mat<3, 3, T>& m2)
{
...
inline constexpr mat<3, 3, T> operator+(const mat<3, 3, T>& m)
{
    return mat<3, 3, T>(+m.columns[0], +m.columns[1], +m.columns[2]);
}
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T>& operator++(mat<3, 3, T>& m)
{
    m.columns[0]++;
    m.columns[1]++;
    m.columns[2]++;
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T> operator++(mat<3, 3, T>& m, int)
{
    mat<3, 3, T> result(m);
    ++m;
    return result;
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T> operator+(const mat<3, 3, T>& m, T scaler)
{
    return mat<3, 3, T>(m.columns[0] + scaler, m.columns[1] + scaler, m.columns[2] + scaler);
}

template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T> operator+(T scaler, const mat<3, 3, T>& m)
{
    return mat<3, 3, T>(scaler + m.columns[0], scaler + m.columns[1], scaler + m.columns[2]);
}

template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T> operator+(const mat<3, 3, T>& m1, const mat<3, 3, T>& m2)
{
    return mat<3, 3, T>(m1.columns[0] + m2.columns[0], m1.columns[1] + m2.columns[1], m1.columns[2] + m2.columns[2]);
}
...
inline constexpr mat<3, 3, T> operator-(const mat<3, 3, T>& m1, const mat<3, 3, T>& m2)
{
    return mat<3, 3, T>(m1.columns[0] - m2.columns[0], m1.columns[1] - m2.columns[1], m1.columns[2] - m1.columns[2]);
}
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr vec<3, T> operator*(const mat<3, 3, T>& m, const vec<3, T>& v)
{
    return vec<3, T>(
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr vec<3, T> operator*(const vec<3, T>& v, const mat<3, 3, T>& m)
{
    return vec<3, T>(
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<2, 3, T> operator*(const mat<3, 3, T>& m1, const mat<2, 3, T>& m2)
{
    return mat<2, 3, T>(
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<4, 3, T> operator*(const mat<3, 3, T>& m1, const mat<4, 3, T>& m2)
{
    return mat<4, 3, T>(
        (m1.columns[0].x * m2.columns[0].x) + (m1.columns[1].x * m2.columns[0].y) + (m1.columns[2].x * m2.columns[0].z),
        (m1.columns[0].y * m2.columns[0].x) + (m1.columns[1].y * m2.columns[0].y) + (m1.columns[2].y * m2.columns[0].z),
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr vec<2, T> operator/(const mat<3, 3, T>& m, const vec<3, T>& v)
{
    return inverse(m) * v;
}

template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr vec<2, T> operator/(const vec<3, T>& v, const mat<3, 3, T>& m)
{
    return v * inverse(m);
}
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T>& operator+=(mat<3, 3, T>& m, T scaler)
{
    m.columns[0] += scaler;
    m.columns[1] += scaler;
    m.columns[2] += scaler;
...
template <typename T, typename std::enable_if<is_numeric<T>::value, bool>::type = true>
inline constexpr mat<3, 3, T>& operator+=(mat<3, 3, T>& m1, const mat<3, 3, T>& m2)
{
