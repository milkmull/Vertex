...
static process::id get_pid_impl() noexcept
{
...
static std::string get_environment_variable_impl(const std::string& name)
{
...
static bool set_environment_variable_impl(const std::string& name, const std::string& value)
{
    const std::wstring wname(str::string_cast<wchar_t>(name));
...
static bool clear_environment_variable_impl(const std::string& name)
{
    const std::wstring wname(str::string_cast<wchar_t>(name));
