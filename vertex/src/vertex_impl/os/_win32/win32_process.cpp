#include "vertex_impl/os/_win32/win32_process.hpp"
    ...
    for (int i = 0; i < STREAM_COUNT; ++i)
    {
        ...
        switch (stream.option)
        {
            case io_option::NONE:
            {
                ...
                {
                    WindowsErrorMessage("CreateFileW()");
                    goto cleanup;
                }
            ...
            case io_option::CREATE:
            {
                ...
                {
                    WindowsErrorMessage("CreatePipe()");
                    goto cleanup;
                }
                ...
                {
                    WindowsErrorMessage("SetNamedPipeHandleState()");
                    goto cleanup;
                }
                ...
                {
                    WindowsErrorMessage("SetHandleInformation()");
                    goto cleanup;
                }
            ...
            case io_option::REDIRECT:
            {
                ...
                {
                    VX_ERROR(error::error_code::INVALID_ARGUMENT) << "redirect stream was null";
                    goto cleanup;
                }
...
bool process::process_impl::kill(bool force)
{
    ...
    {
        WindowsErrorMessage("TerminateProcess()");
        return false;
    }
