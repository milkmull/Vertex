...
VX_TEST_CASE(test_vec4b)
{
    ...
    {
        VX_STATIC_CHECK((is_same<typename vec4b::scalar_type, b>::value));
    }
    ...
    {
        VX_STATIC_CHECK(vec4b::TRUE() == vec4b(true, true, true, true));
        VX_STATIC_CHECK(vec4b::FALSE() == vec4b(false, false, false, false));
    }
}
...
VX_TEST_CASE(test_vec4i)
{
    VX_SECTION("scalar type")
    {
        VX_STATIC_CHECK((is_same<typename vec4i::scalar_type, i>::value));
    }
...
VX_TEST_CASE(test_vec4u)
{
    VX_SECTION("scalar type")
    {
        VX_STATIC_CHECK((is_same<typename vec4u::scalar_type, u>::value));
    }
...
VX_TEST_CASE(test_vec4f)
{
    VX_SECTION("scalar type")
    {
        VX_STATIC_CHECK((is_same<typename vec4f::scalar_type, f>::value));
    }
...
VX_TEST_CASE(test_vec4d)
{
    VX_SECTION("scalar type")
    {
        VX_STATIC_CHECK((is_same<typename vec4d::scalar_type, d>::value));
    }
